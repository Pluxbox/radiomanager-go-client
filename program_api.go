 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "disabled" (int32) Search on Disabled status *(Optional)*
...
func (a *ProgramApiService) ListPrograms(ctx context.Context, localVarOptionals map[string]interface{}) (ProgramResults,  *http.Response, error) {
	...
	if err := typeCheckParameter(localVarOptionals["disabled"], "int32", "disabled"); err != nil {
		return successPayload, nil, err
	}
	...
	if localVarTempParam, localVarOk := localVarOptionals["disabled"].(int32); localVarOk {
