...
// BroadcastRelationsPresenters struct for BroadcastRelationsPresenters
type BroadcastRelationsPresenters struct {
...
func NewBroadcastRelationsPresenters() *BroadcastRelationsPresenters {
	this := BroadcastRelationsPresenters{}
	return &this
}
...
func (o BroadcastRelationsPresenters) MarshalJSON() ([]byte, error) {
...
type NullableBroadcastRelationsPresenters struct {
	value *BroadcastRelationsPresenters
	isSet bool
}

func (v NullableBroadcastRelationsPresenters) Get() *BroadcastRelationsPresenters {
	return v.value
}

func (v *NullableBroadcastRelationsPresenters) Set(val *BroadcastRelationsPresenters) {
	v.value = val
	v.isSet = true
}

func (v NullableBroadcastRelationsPresenters) IsSet() bool {
	return v.isSet
}

func (v *NullableBroadcastRelationsPresenters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBroadcastRelationsPresenters(val *BroadcastRelationsPresenters) *NullableBroadcastRelationsPresenters {
	return &NullableBroadcastRelationsPresenters{value: val, isSet: true}
}

func (v NullableBroadcastRelationsPresenters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBroadcastRelationsPresenters) UnmarshalJSON(src []byte) error {
	v.isSet = true
