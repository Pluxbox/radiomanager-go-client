...
// BlockRelationsBroadcast struct for BlockRelationsBroadcast
type BlockRelationsBroadcast struct {
...
func (o BlockRelationsBroadcast) MarshalJSON() ([]byte, error) {
...
type NullableBlockRelationsBroadcast struct {
	value *BlockRelationsBroadcast
	isSet bool
}

func (v NullableBlockRelationsBroadcast) Get() *BlockRelationsBroadcast {
	return v.value
}

func (v *NullableBlockRelationsBroadcast) Set(val *BlockRelationsBroadcast) {
	v.value = val
	v.isSet = true
}

func (v NullableBlockRelationsBroadcast) IsSet() bool {
	return v.isSet
}

func (v *NullableBlockRelationsBroadcast) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlockRelationsBroadcast(val *BlockRelationsBroadcast) *NullableBlockRelationsBroadcast {
	return &NullableBlockRelationsBroadcast{value: val, isSet: true}
}

func (v NullableBlockRelationsBroadcast) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlockRelationsBroadcast) UnmarshalJSON(src []byte) error {
	v.isSet = true
