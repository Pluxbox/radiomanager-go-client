...
func (o TagRelationsItems) MarshalJSON() ([]byte, error) {
...
type NullableTagRelationsItems struct {
	value *TagRelationsItems
	isSet bool
}

func (v NullableTagRelationsItems) Get() *TagRelationsItems {
	return v.value
}

func (v *NullableTagRelationsItems) Set(val *TagRelationsItems) {
	v.value = val
	v.isSet = true
}

func (v NullableTagRelationsItems) IsSet() bool {
	return v.isSet
}

func (v *NullableTagRelationsItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTagRelationsItems(val *TagRelationsItems) *NullableTagRelationsItems {
	return &NullableTagRelationsItems{value: val, isSet: true}
}

func (v NullableTagRelationsItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTagRelationsItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
