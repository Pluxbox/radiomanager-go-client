...
// TagRelationsContacts struct for TagRelationsContacts
type TagRelationsContacts struct {
...
func (o TagRelationsContacts) MarshalJSON() ([]byte, error) {
...
type NullableTagRelationsContacts struct {
	value *TagRelationsContacts
	isSet bool
}

func (v NullableTagRelationsContacts) Get() *TagRelationsContacts {
	return v.value
}

func (v *NullableTagRelationsContacts) Set(val *TagRelationsContacts) {
	v.value = val
	v.isSet = true
}

func (v NullableTagRelationsContacts) IsSet() bool {
	return v.isSet
}

func (v *NullableTagRelationsContacts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTagRelationsContacts(val *TagRelationsContacts) *NullableTagRelationsContacts {
	return &NullableTagRelationsContacts{value: val, isSet: true}
}

func (v NullableTagRelationsContacts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTagRelationsContacts) UnmarshalJSON(src []byte) error {
	v.isSet = true
