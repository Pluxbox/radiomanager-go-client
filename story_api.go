 ...
 * @return *StoryResults
 */
func (a StoryApi) ListStories(page int64, itemId int64, modelTypeId int64, tagId int64, limit int64, orderBy string, orderDirection string, externalStationId int64) (*StoryResults, *APIResponse, error) {
