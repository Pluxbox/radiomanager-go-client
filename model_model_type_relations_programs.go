...
// ModelTypeRelationsPrograms struct for ModelTypeRelationsPrograms
type ModelTypeRelationsPrograms struct {
...
func NewModelTypeRelationsPrograms() *ModelTypeRelationsPrograms {
	this := ModelTypeRelationsPrograms{}
	return &this
}
...
func (o ModelTypeRelationsPrograms) MarshalJSON() ([]byte, error) {
...
type NullableModelTypeRelationsPrograms struct {
	value *ModelTypeRelationsPrograms
	isSet bool
}

func (v NullableModelTypeRelationsPrograms) Get() *ModelTypeRelationsPrograms {
	return v.value
}

func (v *NullableModelTypeRelationsPrograms) Set(val *ModelTypeRelationsPrograms) {
	v.value = val
	v.isSet = true
}

func (v NullableModelTypeRelationsPrograms) IsSet() bool {
	return v.isSet
}

func (v *NullableModelTypeRelationsPrograms) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelTypeRelationsPrograms(val *ModelTypeRelationsPrograms) *NullableModelTypeRelationsPrograms {
	return &NullableModelTypeRelationsPrograms{value: val, isSet: true}
}

func (v NullableModelTypeRelationsPrograms) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelTypeRelationsPrograms) UnmarshalJSON(src []byte) error {
	v.isSet = true
