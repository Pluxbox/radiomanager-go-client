...
type InlineResponse20010 struct {
	...
	Results []PresenterResult `json:"results,omitempty"`
}
...
// SetResults gets a reference to the given []PresenterResult and assigns it to the Results field.
