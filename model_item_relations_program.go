...
// ItemRelationsProgram struct for ItemRelationsProgram
type ItemRelationsProgram struct {
...
func (o ItemRelationsProgram) MarshalJSON() ([]byte, error) {
...
type NullableItemRelationsProgram struct {
	value *ItemRelationsProgram
	isSet bool
}

func (v NullableItemRelationsProgram) Get() *ItemRelationsProgram {
	return v.value
}

func (v *NullableItemRelationsProgram) Set(val *ItemRelationsProgram) {
	v.value = val
	v.isSet = true
}

func (v NullableItemRelationsProgram) IsSet() bool {
	return v.isSet
}

func (v *NullableItemRelationsProgram) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableItemRelationsProgram(val *ItemRelationsProgram) *NullableItemRelationsProgram {
	return &NullableItemRelationsProgram{value: val, isSet: true}
}

func (v NullableItemRelationsProgram) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableItemRelationsProgram) UnmarshalJSON(src []byte) error {
	v.isSet = true
