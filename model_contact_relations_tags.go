...
// ContactRelationsTags struct for ContactRelationsTags
type ContactRelationsTags struct {
...
func (o ContactRelationsTags) MarshalJSON() ([]byte, error) {
...
type NullableContactRelationsTags struct {
	value *ContactRelationsTags
	isSet bool
}

func (v NullableContactRelationsTags) Get() *ContactRelationsTags {
	return v.value
}

func (v *NullableContactRelationsTags) Set(val *ContactRelationsTags) {
	v.value = val
	v.isSet = true
}

func (v NullableContactRelationsTags) IsSet() bool {
	return v.isSet
}

func (v *NullableContactRelationsTags) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableContactRelationsTags(val *ContactRelationsTags) *NullableContactRelationsTags {
	return &NullableContactRelationsTags{value: val, isSet: true}
}

func (v NullableContactRelationsTags) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableContactRelationsTags) UnmarshalJSON(src []byte) error {
	v.isSet = true
