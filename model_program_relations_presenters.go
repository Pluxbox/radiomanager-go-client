...
// ProgramRelationsPresenters struct for ProgramRelationsPresenters
type ProgramRelationsPresenters struct {
...
func NewProgramRelationsPresenters() *ProgramRelationsPresenters {
	this := ProgramRelationsPresenters{}
	return &this
}
...
func (o ProgramRelationsPresenters) MarshalJSON() ([]byte, error) {
...
type NullableProgramRelationsPresenters struct {
	value *ProgramRelationsPresenters
	isSet bool
}

func (v NullableProgramRelationsPresenters) Get() *ProgramRelationsPresenters {
	return v.value
}

func (v *NullableProgramRelationsPresenters) Set(val *ProgramRelationsPresenters) {
	v.value = val
	v.isSet = true
}

func (v NullableProgramRelationsPresenters) IsSet() bool {
	return v.isSet
}

func (v *NullableProgramRelationsPresenters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProgramRelationsPresenters(val *ProgramRelationsPresenters) *NullableProgramRelationsPresenters {
	return &NullableProgramRelationsPresenters{value: val, isSet: true}
}

func (v NullableProgramRelationsPresenters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProgramRelationsPresenters) UnmarshalJSON(src []byte) error {
	v.isSet = true
