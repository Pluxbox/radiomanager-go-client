...
// CampaignRelationsItems struct for CampaignRelationsItems
...
func (o *CampaignRelationsItems) GetParams() CampaignRelationsItemsParams {
	if o == nil || isNil(o.Params) {
		var ret CampaignRelationsItemsParams
		return ret
	}
	return *o.Params
}
...
// SetParams gets a reference to the given CampaignRelationsItemsParams and assigns it to the Params field.
func (o *CampaignRelationsItems) SetParams(v CampaignRelationsItemsParams) {
	o.Params = &v
}

func (o CampaignRelationsItems) MarshalJSON() ([]byte, error) {
...
type NullableCampaignRelationsItems struct {
	value *CampaignRelationsItems
	isSet bool
}

func (v NullableCampaignRelationsItems) Get() *CampaignRelationsItems {
	return v.value
}

func (v *NullableCampaignRelationsItems) Set(val *CampaignRelationsItems) {
	v.value = val
	v.isSet = true
}

func (v NullableCampaignRelationsItems) IsSet() bool {
	return v.isSet
}

func (v *NullableCampaignRelationsItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCampaignRelationsItems(val *CampaignRelationsItems) *NullableCampaignRelationsItems {
	return &NullableCampaignRelationsItems{value: val, isSet: true}
}

func (v NullableCampaignRelationsItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCampaignRelationsItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
