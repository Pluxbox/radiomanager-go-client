...
func (o BroadcastRelationsItems) MarshalJSON() ([]byte, error) {
...
type NullableBroadcastRelationsItems struct {
	value *BroadcastRelationsItems
	isSet bool
}

func (v NullableBroadcastRelationsItems) Get() *BroadcastRelationsItems {
	return v.value
}

func (v *NullableBroadcastRelationsItems) Set(val *BroadcastRelationsItems) {
	v.value = val
	v.isSet = true
}

func (v NullableBroadcastRelationsItems) IsSet() bool {
	return v.isSet
}

func (v *NullableBroadcastRelationsItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBroadcastRelationsItems(val *BroadcastRelationsItems) *NullableBroadcastRelationsItems {
	return &NullableBroadcastRelationsItems{value: val, isSet: true}
}

func (v NullableBroadcastRelationsItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBroadcastRelationsItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
