...
// BroadcastRelationsGroup struct for BroadcastRelationsGroup
type BroadcastRelationsGroup struct {
...
func (o BroadcastRelationsGroup) MarshalJSON() ([]byte, error) {
...
type NullableBroadcastRelationsGroup struct {
	value *BroadcastRelationsGroup
	isSet bool
}

func (v NullableBroadcastRelationsGroup) Get() *BroadcastRelationsGroup {
	return v.value
}

func (v *NullableBroadcastRelationsGroup) Set(val *BroadcastRelationsGroup) {
	v.value = val
	v.isSet = true
}

func (v NullableBroadcastRelationsGroup) IsSet() bool {
	return v.isSet
}

func (v *NullableBroadcastRelationsGroup) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBroadcastRelationsGroup(val *BroadcastRelationsGroup) *NullableBroadcastRelationsGroup {
	return &NullableBroadcastRelationsGroup{value: val, isSet: true}
}

func (v NullableBroadcastRelationsGroup) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBroadcastRelationsGroup) UnmarshalJSON(src []byte) error {
	v.isSet = true
