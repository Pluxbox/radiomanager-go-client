...
// GroupRelationsPrograms struct for GroupRelationsPrograms
type GroupRelationsPrograms struct {
...
func (o GroupRelationsPrograms) MarshalJSON() ([]byte, error) {
...
type NullableGroupRelationsPrograms struct {
	value *GroupRelationsPrograms
	isSet bool
}

func (v NullableGroupRelationsPrograms) Get() *GroupRelationsPrograms {
	return v.value
}

func (v *NullableGroupRelationsPrograms) Set(val *GroupRelationsPrograms) {
	v.value = val
	v.isSet = true
}

func (v NullableGroupRelationsPrograms) IsSet() bool {
	return v.isSet
}

func (v *NullableGroupRelationsPrograms) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGroupRelationsPrograms(val *GroupRelationsPrograms) *NullableGroupRelationsPrograms {
	return &NullableGroupRelationsPrograms{value: val, isSet: true}
}

func (v NullableGroupRelationsPrograms) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGroupRelationsPrograms) UnmarshalJSON(src []byte) error {
	v.isSet = true
