...
// ItemRelationsCampaign struct for ItemRelationsCampaign
...
func (o ItemRelationsCampaign) MarshalJSON() ([]byte, error) {
...
type NullableItemRelationsCampaign struct {
	value *ItemRelationsCampaign
	isSet bool
}

func (v NullableItemRelationsCampaign) Get() *ItemRelationsCampaign {
	return v.value
}

func (v *NullableItemRelationsCampaign) Set(val *ItemRelationsCampaign) {
	v.value = val
	v.isSet = true
}

func (v NullableItemRelationsCampaign) IsSet() bool {
	return v.isSet
}

func (v *NullableItemRelationsCampaign) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableItemRelationsCampaign(val *ItemRelationsCampaign) *NullableItemRelationsCampaign {
	return &NullableItemRelationsCampaign{value: val, isSet: true}
}

func (v NullableItemRelationsCampaign) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableItemRelationsCampaign) UnmarshalJSON(src []byte) error {
	v.isSet = true
