...
func (o *ItemRelationsContacts) GetParams() ItemRelationsContactsParams {
	if o == nil || isNil(o.Params) {
		var ret ItemRelationsContactsParams
		return ret
	}
	return *o.Params
}
...
// SetParams gets a reference to the given ItemRelationsContactsParams and assigns it to the Params field.
func (o *ItemRelationsContacts) SetParams(v ItemRelationsContactsParams) {
	o.Params = &v
}

func (o ItemRelationsContacts) MarshalJSON() ([]byte, error) {
...
type NullableItemRelationsContacts struct {
	value *ItemRelationsContacts
	isSet bool
}

func (v NullableItemRelationsContacts) Get() *ItemRelationsContacts {
	return v.value
}

func (v *NullableItemRelationsContacts) Set(val *ItemRelationsContacts) {
	v.value = val
	v.isSet = true
}

func (v NullableItemRelationsContacts) IsSet() bool {
	return v.isSet
}

func (v *NullableItemRelationsContacts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableItemRelationsContacts(val *ItemRelationsContacts) *NullableItemRelationsContacts {
	return &NullableItemRelationsContacts{value: val, isSet: true}
}

func (v NullableItemRelationsContacts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableItemRelationsContacts) UnmarshalJSON(src []byte) error {
	v.isSet = true
